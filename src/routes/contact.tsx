    ...
    <section className="border-t border-border/60 bg-gradient-to-br from-[#2767d1]/10 via-background to-card/70">
      <div className="mx-auto max-w-6xl px-6 py-20 md:py-24">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          <Reveal delay={120}>
            <div className="flex h-full flex-col rounded-[1.75rem] border border-border bg-card/80 p-6 shadow-sm backdrop-blur-sm sm:p-8">
          ...
          <Reveal delay={180}>
            <div className="flex h-full flex-col rounded-[1.75rem] border border-border bg-gradient-to-br from-accent/10 via-card to-card/80 p-6 shadow-sm sm:p-8">
              <div className="flex items-center gap-3">
              ...
              <p className="mt-6 text-base leading-relaxed text-foreground/70">
                Це місце, де проводяться авторські вечори, презентації та мистецькі заходи проєкту «Літературні забави».
              </p>
