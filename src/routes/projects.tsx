  ...
  <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 py-20 md:grid-cols-[1fr_1.4fr]">
    ...
    <Reveal delay={120}>
      ...
      <p className="text-lg leading-relaxed text-foreground/85">
        ...
        символ належності до спільноти, що творить сучасну українську літературу, та брендований записник. Це наш маленький знак вдячності кожному з них.
      </p>
      <p className="mt-3 text-muted-foreground">
        Це маленький знак вдячності та приналежності до спільноти.
      </p>
    </Reveal>
  </div>
</section>
